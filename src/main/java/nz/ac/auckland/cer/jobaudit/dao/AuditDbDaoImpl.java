...
public class AuditDbDaoImpl extends SqlSessionDaoSupport implements AuditDbDao {
    ...
    public Future<List<User>> getUsers() throws Exception {
        ...
        return this.executorService.submit(new Callable<List<User>>() {
    ...
    public List<User> getUsersForAccountNames(
            final List<String> accountNames) throws Exception {
    ...
    public Future<List<String>> getAccountNames(
            final String bottom,
    ...
    public Future<List<String>> getAccountNamesForProject(
    ...
    public Future<List<String>> getAccountNamesForAffiliation(
    ...
    public Future<List<String>> getAccountNamesForAffiliation(
        ...
        return this.executorService.submit(new Callable<List<String>>() {
            public List<String> call() throws Exception {
                ...
                return getSqlSession().selectList("getAccountNamesForAffiliationCodeAndDept1AndDept2", params);
            }
        });
    }
    ...
    public boolean isCurrentUserAdmin(
            String tuakiriUniqueId) throws Exception {
    ...
    public Future<Integer> getNumberRecords(
            final String accountName) throws Exception {
    ...
    public Future<List<AuditRecord>> getRecords(
        ...
        return this.executorService.submit(new Callable<List<AuditRecord>>() {
    ...
    public List<UserStatistics> getStatisticsForAccountNames(
        ...
        if ((to.getTimeInMillis()) > (System.currentTimeMillis() - 86400000)) {
            ...
            return getStatisticsForAccountNames(accountNames, "" + (curr.getTimeInMillis() / 1000), mid, high, ""
            ...
            mmFrom = tempFrom + "";
            mmTo = tempTo + "";
            return getStatisticsForAccountNames(accountNames, "" + from.get(Calendar.YEAR)
                    + (mmFrom.length() == 1 ? "0" + mmFrom : mmFrom), "" + to.get(Calendar.YEAR)
                    + (mmTo.length() == 1 ? "0" + mmTo : mmTo));
        }
    }

    // get statistics for data older than 24 hours
    private List<UserStatistics> getStatisticsForAccountNames(
            final List<String> accountNames,
            final String bottom,
            final String top) throws Exception {
    ...
    public List<UserStatistics> getStatisticsForProject(
        ...
        if ((to.getTimeInMillis()) > (System.currentTimeMillis() - 86400000)) {
            ...
            return getStatisticsForProject(project, "" + from.get(Calendar.YEAR)
                    + (mmFrom.length() == 1 ? "0" + mmFrom : mmFrom), "" + to.get(Calendar.YEAR)
                    + (mmTo.length() == 1 ? "0" + mmTo : mmTo));
        }
    }
    ...
    // get statistics for data older than 24 hours
    private List<UserStatistics> getStatisticsForProject(
            final String project,
            final String bottom,
            final String top) throws Exception {
    ...
    public List<Future<BarDiagramStatistics>> getBarDiagramAccountNamesStatistics(
            final List<String> accountNames,
            Integer startYear,
            Integer startMonth,
            Integer endYear,
        ...
        if ((to.get(Calendar.YEAR) > currYear) || (to.get(Calendar.MONTH) >= currMonth)
                && (to.get(Calendar.YEAR) == currYear)) {
            currMonthInRange = true;
            to.set(currYear, currMonth - 1, 1, 0, 0, 0);
        }

        from.set(startYear, month, 1, 0, 0, 0);
        while ((from.get(Calendar.YEAR) <= to.get(Calendar.YEAR) && !(from.get(Calendar.YEAR) == to.get(Calendar.YEAR) && from
                .get(Calendar.MONTH) > to.get(Calendar.MONTH)))) {
            if (accountNames.size() < 1) {
                fbdslist.add(getBarDiagramStatisticsForAllAccountNames("" + (from.get(Calendar.MONTH) + 1),
                        "" + from.get(Calendar.YEAR)));
            } else {
                fbdslist.add(getBarDiagramStatisticsForAccountNameSet(accountNames,
    ...
    public Future<BarDiagramStatistics> getBarDiagramStatisticsForAllAccountNames(
            final String bottom,
            final String top) throws Exception {

        return this.executorService.submit(new Callable<BarDiagramStatistics>() {
    ...
    public List<Future<BarDiagramStatistics>> getProjectStats(
            final String project,
            Integer startYear,
            Integer startMonth,
            Integer endYear,
    ...
    public Future<BarDiagramStatistics> getBarDiagramStatisticsForProject(
            final String project,
            final String bottom,
            final String top) throws Exception {
    ...
    // get bar diagram statistics for current month's data
    public Future<BarDiagramStatistics> getBarDiagramStatisticsForProjectCurr(
            final String project,
            final String bottom,
            final String mid,
            final String top) throws Exception {
