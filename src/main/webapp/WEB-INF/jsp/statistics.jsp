        ...
        <c:when test="${not empty userStatistics}">
          ...
          <table id="bordered">
            ...
            <tr>
              ...
              <td align="right"><b>${totalNumberGridJobs}</b>
                (<script type="text/javascript">
                  document.write(parseFloat("${gridJobsPercentage}").toFixed(2));
                </script> %)
              </td>
            </tr>
            <tr>
              ...
              <td align="right"><b>
                <script type="text/javascript">
                  document.write(parseFloat("${totalCoreHours}").toFixed(2));
                </script></b>
              </td>
              <td align="right"><b>
                <script type="text/javascript">
                  document.write(parseFloat("${totalGridCoreHours}").toFixed(2));
                </script></b> (
                <script type="text/javascript">
                  document.write(parseFloat("${gridTotalHoursPercentage}").toFixed(2));
                </script> %)
              </td>
            </tr>
          </table>
